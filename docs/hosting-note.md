...
This implementation is Compose-first. The `web` container serves the Vite React bundle through Nginx and proxies storefront paths such as `/catalog`, `/buy/*`, `/stripe/*`, `/telegram/*`, `/dl/*`, `/admin*`, and `/download-file/*` to internal backend containers.
