...
export const navItems: NavItem[] = [
  ...
  { label: "Videos", href: "/videos", section: "videos", accent: "steel" },
...
export const findomSubnav: NavItem[] = [
  ...
  { label: "Contracts", href: "/findom/contracts", section: "findom", accent: "red" }
];

export const aboutSubnav: NavItem[] = [
  { label: "About", href: "/about", section: "about", accent: "amber" },
